...
const Match649 = () => (
  <div>
    ...
    <div className="container">
      ...
      <h2 className="text-center text-lg">₦3,700.000.00</h2>
      <p className="text-center">Select 6 numbers from 1 - 49 or choose quick pick <br />
      ...
      <div className="row">
        <div className="col-lg-4">
          <div className="select-number-area">
            ...
            <ul className="number-list match-649">
              <li>1</li>
              <li>2</li>
        ...
        <div className="lottery-search-area custom-div">
          ...
          <div className="row">
          <div className="col-6">
          <Link to="/match649-play" className="center playe-btn">Play</Link>
              </div>
              <div className="col-6">
