      ...
      <div>
        ...
        <div className="container">
          <div className="match matches-width">
            <img src="/assets/images/Group 4522.png" className="img-fluid" alt="Responsive"></img>
          </div>
          <h2 className="text-center text-lg">₦8,000.00</h2>
          <p className="text-center">Select 3 numbers from 0 - 9 or choose quick pick <br />
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="select-number-area match-3-select">
                <h3 className="title">Select Number</h3>
                <ul className="number-list match-3">
                  <li>0</li>
                  <li>0</li>
            ...
            <div className="col-lg-4">
              <div className="number-select-area">
                <h3 className="title">Number of tickets selected: 3 </h3>
                <ul className="number-lis">
                  <li>0</li>
                  <li>1</li>
                  <li>4</li>
            ...
            <div className="lottery-search-area custom-div">
              ...
              <div className="row">
              <div className="col-6">
              <Link to="/match3-play" className="center playe-btn">Play</Link>
                  </div>
                  <div className="col-6">
