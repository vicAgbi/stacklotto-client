  ...
  return (
    ...
    />
      ...
      <div className="match matches-width">
        <img src="/assets/images/Group 4521.png" className="img-fluid" alt="Responsive"/>
  
      </div>
  
      <div className="text">
        <p> Number of tickets selected: 2</p>
        <p> Play Type Selected: Any order</p>
        <p>Cost of ticket selection:  ₦400.00</p>
